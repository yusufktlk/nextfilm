...
async function TVSimilar(params) {
    ...
    async function getSimilarSeries() {
        const options = {
          ...
          const res = await fetch(`https://api.themoviedb.org/3/tv/${id}/similar?language=en-US&page=1`,options)
          return res.json()
    }
    
    const data = await getSimilarSeries()
